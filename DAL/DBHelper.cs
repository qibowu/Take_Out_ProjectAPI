...
namespace DAL
{
    public static class DBHelper
    {
        ...
        //获取web.config里的连接字符串
        public static  string strCon = ConfigurationManager.ConnectionStrings["DBname"].ConnectionString;
        ...
        /// <returns></returns>
        public static int ExecuteNonQueryByProcedure(string procName, params SqlParameter[] paras)
        {
            //实例化连接对象
